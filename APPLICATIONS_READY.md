...
Drafted CV + cover letter PDFs. Most career emails submitted via Resend. **Portal-only / mailto left:** Directive Digital Marketing Strategist Startups/SMB (Ashby https://jobs.ashbyhq.com/directive/6c171165-a1a6-4851-b0d9-a7f0b822c424), VixelStudio SEO Account Manager (Google Form https://forms.gle/tT1yQzgZbY9pmvVZ9 / contact@vixelstudio.com), Practice Better Lifecycle Marketing Specialist (Greenhouse / careers@practicebetter.io), Edmonton Community Foundation Marketing Associate (jobs@ecf.ca), Conversion Digital Marketing Automation Delivery Specialist (hello@conversiondigital.ca / LinkedIn), Power Digital Paid Advertising Specialist (Greenhouse), Marble Marketing Strategist (Lever / Plum survey), Y2Y Digital Marketing Specialist (BambooHR / careers@y2y.net), Origin Demand Generation Lead (Ashby), Audi RED Dealer Performance Specialist (JazzHR), Webserv SEO Specialist (LinkedIn), Directive Digital Marketing Manager (Ashby / Built In), Propellic Paid Media Manager (LinkedIn), Jobgether SEO Strategist / Paid Media Meta / Google Ads (LinkedIn / Jobgether), Level Agency Paid Media Manager (LinkedIn), BlueTuskr Search Advertising Specialist (LinkedIn), ZayZoon GTM Automation Specialist I (Ashby / LinkedIn), Marketbridge Specialist SEM (LinkedIn / Marketbridge careers), EPCOR Advisor Marketing Operations (EPCOR careers / LinkedIn), Odd Bunch Paid Search (LinkedIn), DOE Media Account Manager (LinkedIn), Levven Marketing Specialist (LinkedIn), Binary Stream Marketing Specialist (BambooHR / LinkedIn), Fortra Web Strategy Lead (LinkedIn), Victor Energy Marketing Coordinator (LinkedIn / Victor careers), ACX Media & Performance (LinkedIn), Laivly Digital Marketing Specialist (BambooHR), CanadaOne Digital Marketing Coordinator, Attention Paid Media (tyler@attentioncompany.ca), Roveia Performance Marketing Lead, Roveia Marketing Account Manager, Flywheel Paid Growth Lead, Acceler8 Paid Search, Ross Video Marketing Automation, Herb KAM (careers@herb.co), White Bay, Clever SEM, Ignite PPC, AMA, Keysight, Elevation, AutoCanada AM, NP Digital, Powered by Search, Odds Scanner, Brafton, CCWESTT, BIS Web Optimization, Jobgether Organic Growth / Meta PPC / SDMC (+ optional form follow-ups). Local: Fastener Group Warehouse Associate South LinkedIn (#FD); JC Silent-Aire Assembler Weekend Night LinkedIn (#FE); Western Truck Body Material Handler mailto wtbhr@westerntruckbody.com (#FB); JC Silent-Aire Assembler Panels LinkedIn (#FC); Bevo Farms mailto recruiting@bevofarms.com (#FA); Walmart Overnight Calgary Trail / Stock Unloader Parsons / Purolator AM 493 careers; Sureway JR Inventory LinkedIn; Argus emailed; Apex mailto HR@apexdistribution.com (#DB refresh); Applied LinkedIn / jobs.applied.com (#ES); Fountain Tire Roper careers/in-store (#ET); Microserve mailto info@microserve.ca; Super Slings mailto info@superslings.ca; Steele's mailto info@steelesgroup.com; Walmart OMNI Calgary Trail / HelloFresh careers; Home Depot Strathcona careers; Amrize LinkedIn; Fountain Tire Leduc LinkedIn; Capital Chrysler AutoCanada careers; Sureway Shop Labourer LinkedIn; FedEx careers; Go Kia South mailto careers@goauto.ca; CGIS mailto hr@cgis.ca; optional Echelon edmontonsales@echelonsupply.com.
...
| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C87 | Digital Shift® | Digital Marketing Account Manager | High (~78) | **PORTAL** https://join.digitalshiftmedia.com/account-management/ · LinkedIn https://ca.linkedin.com/jobs/view/4461837526 · mailto:contact@digitalshiftmedia.com · https://digitalshiftmedia.com/careers/digital-marketing-account-manager/ | `cv/main_digital_shift.pdf` | `cover_letters/cover_digital_shift_account_manager.pdf` | Remote Canada; CAD $60–85k (aggregator); SEO/local/GBP/GA4 + client ownership match; deep HVAC/plumbing/roofing agency book still growing vs 2 SMB |

**Email sent this run (Resend):** Digital Shift → contact@digitalshiftmedia.com id `89958b89-9769-4431-98d9-b2855d93e59d` (CV+cover). Still complete join.digitalshiftmedia.com form. ChampionX = LinkedIn/SLB portal. No LinkedIn/Indeed portal submit claimed.

**Local drafts this run:** ChampionX / Alberta Oil Tool Injection Molding Operator (6939 68 Ave NW) — see `APPLICATIONS_LOCAL.md` (#FR).

Skipped this run (fit/location/pay): Safeway Grocery Clerk SW (Southgate PF hard skip); Walmart OMNI 18521 Stony Plain Rd NW (west); Rexel Warehouse Clerk twin; Saputo Main Warehouse 16110 116 Ave NW (west); Loblaw Receiver Night (store address unverified); Maple Leaf Logistics Team Leader (people-lead stretch); Clean Harbors Hydro Vac (specialized travel); Pilot Flying J Nisku cashier; Starbucks Leduc; UFA Westlock; Champion Petfoods Acheson; Tier 1 Clicks Google Ads Specialist (Google-only / LSA deep-specialist filter ~55); Blacksmith Google Ads Specialist oversee-specialists twin (~50); Foundation GEO Strategist (5+ yrs mentor ~50); Jobgether SEO Strategist twin of C68; Directive SEO Strategist FO twin; Powered by Search Senior SEO; EY Brand Lead / Assistant Director senior; Willowglen Director Sales & Marketing; Nasdaq Verafin Senior Digital Marketing; TopHat SEO/AEO Lead; Sweat Pants twin; sales/Account Manager noise.
...
| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C80 | Directive | Digital Marketing Strategist - Startups/SMB | High (~74) | **PORTAL / Ashby** https://jobs.ashbyhq.com/directive/6c171165-a1a6-4851-b0d9-a7f0b822c424 · remote Canada · internal title Demand Generation Manager | `cv/main_directive_dms.pdf` | `cover_letters/cover_directive_digital_marketing_strategist.pdf` | Remote Canada; living wage posted (confirm ≥ CAD $60k); agency IC paid+SEO+client ownership match; deep B2B SaaS + CRO + up-to-7 account book still growing vs 2 SMB |

**Email sent this run (Resend):** none with a verified public apply inbox (Directive = Ashby portal; Fastener Group / JC Silent-Aire weekend = LinkedIn/careers). No LinkedIn/Indeed portal submit claimed.

**Local drafts this run:** The Fastener Group Warehouse Associate 1 Edmonton South (9619 42 Ave NW), Johnson Controls / Silent-Aire Assembler Weekend Night Shift (Nisku or Sherwood Park) — see `APPLICATIONS_LOCAL.md` (#FD–#FE).

Skipped this run (fit/location/pay): Rexel/Westburne Warehouse Clerk twin (already #DT); Walmart Stock Unloader 156 87 Ave NW; Walmart Overnight Northgate; Walmart Produce Stocker Tamarack; Cintas Production Folder NW; Durabuilt LGS Assembler (likely NW); Powell Steel Fab Acheson; Sky Eye Materials Tech Acheson; ATCO Material Supply (address unverified); Emco Material Handler (multi-branch address unverified); FedEx Switcher (yard/CDL-preferred); Blacksmith SEO Specialist 4–7 yrs (~50); DOE Search Marketing Manager ecom Shopping high-spend stretch (~55); CHIROK SEO (LinkedIn Part-time); Clio Customer Marketing (Burnaby/Calgary/Toronto offices); Corus Orthodontists SEO Manager Calgary 5–8 yrs; Seequent Marketing Automation Vancouver hybrid 5 yrs; Grafana Demand Gen 5+ yrs; Ashby Marketing Strategy 7+ yrs; Hypertec Growth Marketing Montreal 5+ yrs; BMO Senior Manager Campaign AI Toronto; goeasy Senior Digital Performance Mississauga; Fuze HR DMS Montreal onsite; Sweat Pants / Hire Feed patterns.

## NEW drafts this run (2026-08-31 daily scrape)
...
**Local drafts this run:** Western Truck Body Material Handler Break & Shear (6115 30 St NW), Johnson Controls / Silent-Aire Assembler Panels Nisku — see `APPLICATIONS_LOCAL.md` (#FB–#FC).

Skipped this run (fit/location/pay): Cintas Production Folder (17811 116 Ave NW); Walmart Claims Kingsway Mall; JC Material Coordinator SAP/BOM SME; Rexel DC Manager; UniFirst Route Trainee (delivery/customer); Capital Chrysler Wholesale Parts Advisor (sales/CDK); HelloFresh Production Lead (30+ people supervise); Mammoet Jack/Slide travel; Sweat Pants / AtomCareer / Jobgether Google Ads high-spend twins; Directive Lifecycle Lead 6+ yrs $130–160k; Remotivate Dominant Digital US-only; Off2Class GTA primarily; TopHat AM GTA; Blacksmith Content Marketing Manager; Absorb Senior Manager 8+ yrs; Tru SEO+ Hybrid Toronto; Elevation Applied AI engineer stretch; IATA Montreal; Seequent Vancouver; CI Financial Toronto; HD Personalization Toronto; Hire Feed / aggregator patterns.

## NEW drafts this run (2026-08-30 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C78 | Practice Better | Lifecycle Marketing Specialist | Good (~61) | **PORTAL / Greenhouse** https://job-boards.greenhouse.io/practicebetter/jobs/5351299008 · mailto careers@practicebetter.io · LinkedIn https://ca.linkedin.com/jobs/view/4455424948 | `cv/main_practice_better.pdf` | `cover_letters/cover_practice_better_lifecycle_marketing.pdf` | Remote Canada; CAD $60–70k posted; GHL lifecycle + Claude ops match; HubSpot (required) + Pendo + B2B SaaS practitioner lifecycle still growing vs 2 SMB |

**Email sent this run (Resend):** Bevo Farms General Labourer → recruiting@bevofarms.com id `2e2021a0-4706-4409-adcd-6be5688a6448` (local CV; From dylan@luminmarketinggroup.com; Reply-To dylanschule@live.ca). Practice Better → careers@practicebetter.io id `75a678f6-1e32-4cea-87a8-05d1ee5d75e1` (CV+cover). Still complete Practice Better Greenhouse form manually. No LinkedIn/Indeed portal submit claimed.

**Local drafts this run:** Bevo Farms General Labourer (Edmonton greenhouse / Bevo Sky at EIA) — see `APPLICATIONS_LOCAL.md` (#FA).

Skipped this run (fit/location/pay): Walmart OMNI/Overnight Calgary Trail twins (already #EP/#EW); Walmart OMNI Northgate / 87 Ave / Fort Sask; Overnight 127 St; Veolia Sorter Aurum NE; Purolator Sorter PM 514 (114 Ave NW); Federal Signal Yard Hand (5yr forklift); Uline Edmonton-label (St Albert); Powell Acheson; InterPro Camrose; Ingersoll Rand Acheson; Clark Builders Gibbons; Sweat Pants Paid Search / Google Ads / Senior Buyer (high-spend DTC); Hire Feed SEO/Marketing Manager (aggregator); Clever Performance Marketing ($150–300k/mo Meta stretch ~55); DOE TikTok Shop Strategist; Major Tom Media Strategist; Blacksmith SEO/Ads; Directive Account Strategist Paid Media (~55); Jobgether Plumbing DMM / Ecom Growth (5+ yrs); Jiga Growth Lead; Extreme Networks Marketo; INSIDEA HubSpot 5+ yrs; senior Toronto RevOps/MarTech/AI engineer roles.

## NEW drafts this run (2026-08-29 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C76 | Edmonton Community Foundation | Marketing Associate | High (~72) | **EMAIL** mailto:jobs@ecf.ca · https://ecf.ca/career/marketing-associate/ · LinkedIn https://ca.linkedin.com/jobs/view/4460569956 | `cv/main_ecf.pdf` | `cover_letters/cover_ecf_marketing_associate.pdf` | Edmonton hybrid; CAD $64,867–$76,313 posted; paid/SEO/email/CRM match; formal marketing degree + nonprofit foundation CRM still growing vs 2 SMB |
| C77 | Conversion Digital | Marketing Automation Delivery Specialist | Good (~64) | **EMAIL / LinkedIn** mailto:hello@conversiondigital.ca · https://ca.linkedin.com/jobs/view/4459408695 · https://conversiondigital.ca | `cv/main_conversion_digital.pdf` | `cover_letters/cover_conversion_digital_marketing_automation.pdf` | Flexible Canada; CAD $65–75k posted; GHL lifecycle + QA/docs match; SFMC/Adobe/Marketo/Braze enterprise platforms still growing vs 2 SMB |

**Email sent this run (Resend):** ECF Marketing Associate → jobs@ecf.ca id `a61ddc46-c5d8-4da5-9fc2-b987bba0ab55` (CV+cover; From dylan@luminmarketinggroup.com; Reply-To dylanschule@live.ca). Conversion Digital → hello@conversiondigital.ca id `5afb37be-1a60-4e12-8a41-3c2885ab9bfb` (CV+cover). No public apply email for Walmart / Purolator / Sureway JR Inventory — use careers portals / LinkedIn.

**Local drafts this run:** Walmart Overnight Associate Calgary Trail (3931 Calgary Trail NW), Walmart Stock Unloader Parsons (1203 Parsons Rd NW), Purolator Sorter AM 493 Edmonton South (3104 97 St NW), Sureway JR Inventory Technician (9175 14 St NW) — see `APPLICATIONS_LOCAL.md` (#EW–#EZ).

Skipped this run (fit/location/pay): Walmart Stock Unloader Calgary Trail re-post (already #BB); Walmart Stock Unloader Stony Plain Rd / Overnight 87 Ave (west); Sureway Shop Labourer re-post (already #ED); SECURE Transfer Station (17 St NE); Durabuilt Cell Lead Receiving (111 Ave NW); Heidelberg Plant Helper Villeneuve; Dash Social Performance Marketing Manager (CareerBeacon provinces exclude Alberta); BIS Lifecycle Marketing Manager (HubSpot data build ~52); AMA Marketing Coordinator Member Rewards 14-mo (~52); Blacksmith Google Ads Specialist (4–7 yrs oversee ~50); Sandisk Channel Marketing (6–8 yrs + FR); Clever Digital Senior Performance (Toronto); Saatchi/Aber/Air Canada/BDO/Scotlynn/ARAG/Master Power Toronto-or-onsite; Asana Head of SEO / KITS Senior Manager SEO; Media Experts $45–55k Toronto; Feathery Demand Gen GTA; CCGoodwin 7+ yrs; SEPHORA/Southgate PF patterns.

## NEW drafts this run (2026-08-28 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C74 | Power Digital | Paid Advertising Specialist (Ecommerce) | High (~72) | **PORTAL / Greenhouse** https://job-boards.greenhouse.io/powerdigitalmarketing/jobs/5221806007 · LinkedIn https://ca.linkedin.com/jobs/view/4456968712 | `cv/main_power_digital.pdf` | `cover_letters/cover_power_digital_paid_advertising_specialist.pdf` | Remote Canada; Google+Meta + AI ops match; large multi-brand ecom DR books + Nova/Iris tooling still growing vs 2 SMB; confirm base ≥ CAD $60k |
| C75 | Marble (SettLiT / Medchart) | Marketing Strategist | Good (~66) | **PORTAL / Lever** https://jobs.lever.co/Medchart/5f6e5779-2064-4fb0-8b30-a5d4aa42985c · LinkedIn https://ca.linkedin.com/jobs/view/4458618586 | `cv/main_marble.pdf` | `cover_letters/cover_marble_marketing_strategist.pdf` | Remote Canada; CAD $75–95k posted; generalist shipping + Claude AI match; HubSpot/Webflow/Figma + regulated legal/health SaaS still growing vs 2 SMB |

**Mailto / email this run:** Argus General Labour Nisku + Edmonton Saw Operator → **sent via Resend** id `38dd3bf3-a257-47a3-9460-81094a0449d0` to `info@argusinnovates.com` with `cv/main_local_edmonton.pdf` (From dylan@luminmarketinggroup.com; Reply-To dylanschule@live.ca). No verified public apply email for Power Digital or Marble — use Greenhouse / Lever (+ Plum survey). Fountain Tire Roper via careers / in-store.

**Local drafts this run:** Fountain Tire Labourer Roper Road (5810 50 St NW), Argus General Labour Nisku (2327 5 St), Argus General Labour/Saw Operator Edmonton (5820 97 St NW) — see `APPLICATIONS_LOCAL.md` (#ET–#EV).

Skipped this run (fit/location/pay): Wajax Shipper/Receiver LinkedIn re-post 4459606818 (already #AV Acheson/Edmonton twin); Grainger Warehouse Associate Shipper Afternoon (11708 167 St NW); Optima Living Digital Marketing Specialist (careers listing expired / not on optimaliving.ca openings); Bass Pro Overnight Warehouse Outfitter (15320 37 St NW north); Ryder Material Handler Sherwood Park (Fort Hills camp FIFO pattern); Uline Spruce Grove; Canadian Fiber Optics Warehouse Coordinator (multi-site travel stretch); Blacksmith Performance Marketing Specialist (4–7 yrs oversee specialists ~50); SimplyPHP Digital Marketing Lead (6+ yrs); Jobgether Senior SEO Strategist / SEO AEO GEO Lead (senior/lead R&D stretch ~55); Fresh Focus Performance Marketing (Calgary on-site only); Skunkworks/BC Legal DMS ($50–60k pay floor); AlgaeCal SEO AI Search (already skipped/removed); SEPHORA/Southgate PF patterns; Toronto/Montreal/FR-only.

## NEW drafts this run (2026-08-27 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C72 | Yellowstone to Yukon (Y2Y) | Digital Marketing Specialist | High (~74) | **PORTAL / BambooHR** https://y2y.bamboohr.com/careers/40 · https://y2y.net/careers · mailto careers@y2y.net | `cv/main_y2y.pdf` | `cover_letters/cover_y2y_digital_marketing_specialist.pdf` | Edmonton preferred OK; CAD $63–84k; SEO/WordPress/GA4/paid/email match; NationBuilder + nonprofit fundraising CRM still growing vs 2 SMB |
| C73 | Origin | Demand Generation Lead | Good (~64) | **PORTAL / Ashby** https://jobs.ashbyhq.com/originhq/ecb5a3af-47bd-48cc-bbc8-730680fd2814 · LinkedIn https://ca.linkedin.com/jobs/view/4459110044 | `cv/main_origin.pdf` | `cover_letters/cover_origin_demand_generation_lead.pdf` | Remote US/CA; $115–170k posted; Google Ads + Claude AI ops match; LinkedIn/Reddit Ads + cyber B2B SaaS pipeline + Clay/HubSpot still growing vs 2 SMB |

**Mailto (Resend unset this run):** Apex Warehouse Associate (prior #DB refresh) → `mailto:HR@apexdistribution.com` with `cv/main_local_edmonton.pdf`; Y2Y → `mailto:careers@y2y.net` with CV+cover (also BambooHR). No verified public apply email for Origin — use Ashby. Applied Industrial via LinkedIn / jobs.applied.com.

**Local drafts this run:** Applied Industrial Technologies Warehouse Representative (Nisku T9E 7W1) — see `APPLICATIONS_LOCAL.md` (#ES). Apex Nisku Warehouse Associate re-surfaced as twin of #DB (mailto refreshed; not counted as new).

Skipped this run (fit/location/pay): Apex Warehouse Associate Indeed re-post (already #DB); Celanese Rail Worker Shipping/Receiving (4405 101 Ave NW east distance); Walmart OMNI 156 87 Ave NW / Kingsway Mall / Stock Unloader Stony Plain Rd (west/north); SEPHORA Operations Consultant Southgate (hard skip PF) + Emerald Hills Sherwood Park; Wolseley Inventory Control (branch/DC address unverified; Waterworks NW pattern risk); Stream-Flo Shipper-Receiver ALIS twin (already #CP); Uline St Albert twin; Traction Heavy Vehicle Parts re-post (already #EB); Sureway Parts Technician Journey Person (ticket hard-req); HD Associé Manutention French twin (store unspecified / floor public); Jobgether Google Ads Media Buyer (4+ yrs Demand Gen/ecom DR stretch ~55); Sandborn Social Media & Marketing Coordinator (coord + pay floor unclear ~52); Warrior Digital Paid Media (Ontario-based hard); Blacksmith Content Marketing Manager / SEM Manager (4–7 yrs oversee specialists ~50); Powered by Search Senior SEO Strategist (senior SaaS book stretch / prior PBS pack); EY Brand Marketing Specialist Edmonton (5+ yrs events + degree ~48); SMART Email Marketing Calgary; EIZIE spam; Toronto/Montreal/FR-only marketing roles.

## NEW drafts this run (2026-08-26 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C71 | Audi RED (BIMM / Audi) | Dealer Performance Specialist (Western Canada) | Good (~68) | **PORTAL / JazzHR** https://audired.applytojob.com/apply/7jLAgSzWIi/Dealer-Performance-Specialist-2-Openings · LinkedIn https://ca.linkedin.com/jobs/view/4456541142 | `cv/main_audi_red.pdf` | `cover_letters/cover_audi_red_dealer_performance_specialist.pdf` | Remote Western Canada MST; CAD $70–85k posted; Audi Fixed Ops + SEO/GA4/CMS match; Salesforce / Adobe Analytics / oADD / Mandarin still growing vs 2 SMB accounts |

**Mailto (Resend unset this run):** Microserve Warehouse Associate → `mailto:info@microserve.ca` with `cv/main_local_edmonton.pdf`; Super Slings Shipper-Receiver → `mailto:info@superslings.ca` with `cv/main_local_edmonton.pdf`. No verified public apply email for Audi RED — use JazzHR. Walmart OMNI / HelloFresh via careers portals / LinkedIn.

**Local drafts this run:** Microserve Warehouse Associate (5607 67 Ave NW), Walmart OMNI CFA (3931 Calgary Trail NW), HelloFresh Warehouse Associate (Nisku), Super Slings Shipper-Receiver (Nisku) — see `APPLICATIONS_LOCAL.md` (#EO–#ER).

Skipped this run (fit/location/pay): Maxim Shipper/Receiver/Delivery (13240 170 St NW); Western Dispatch Warehouse Coordinator (114 Ave / 128 Ave NW); 7-Eleven Warehouse Shipping Nights (14434 157 Ave NW); DHL Casual Warehouse (EIA stretch logged); Finning 7x7 twins (West Edmonton); Wolseley Returns / Counter Order Picker (NW Waterworks pattern); E.B. Horsman Material Handler (186 St NW); Sysco Inbound Receiver (Acheson); TECO Shipping (109 Ave NW); Supreme Wetaskiwin; St Albert Honda Shipper; Elevation Capital Applied AI Marketing Engineer re-post (Master’s + Python/SQL production engine ~35; prior pack exists); Blacksmith SEO Analyst (4–7 yrs oversee specialists ~50); Sirius/ProFound Marketing Manager (player-coach industrial full-funnel ~55); AHS Social Media Coordinator (degree + healthcare monitoring ~52); Wave Senior Marketing Automation (Braze/Segment SME ~40); AutoCanada AI Engineer (Azure Foundry / Fabric engineer ~35); Toronto/Montreal/FR-only marketing roles.

## NEW drafts this run (2026-08-25 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C69 | Webserv | SEO Specialist | High (~82) | **PORTAL / LinkedIn** https://ca.linkedin.com/jobs/view/4457106275 | `cv/main_webserv.pdf` | `cover_letters/cover_webserv_seo_specialist.pdf` | Remote Canada; CAD $50–70k posted (confirm base ≥ CAD $60k); Claude/Claude Code + SEO execution + GBP/local match; Screaming Frog depth + behavioral-health YMYL still growing vs 2 SMB accounts |
| C70 | Directive | Digital Marketing Manager (Demand Gen) | Good (~70) | **PORTAL / Ashby** https://jobs.ashbyhq.com/directive/4fcd7c61-332c-4fe4-9d59-38627b363641 · Built In listing | `cv/main_directive_dmm.pdf` | `cover_letters/cover_directive_digital_marketing_manager.pdf` | Remote Canada; living wage posted (confirm ≥ CAD $60k); agency IC paid+SEO+client ownership match; deep B2B SaaS + CRO + up-to-7 account book still growing vs 2 SMB |

**Mailto (Resend unset this run):** Steele's Dock/Forklift → `mailto:info@steelesgroup.com` (also admin@) with `cv/main_local_edmonton.pdf`. No verified public apply email for Webserv or Directive DMM — use LinkedIn / Ashby. Local HD Strathcona / Amrize / Fountain Tire via LinkedIn or careers portals.

**Local drafts this run:** Steele's Dock Coordinator/Forklift (5805 98 St NW), Home Depot Overnight Receiving Supervisor Strathcona #7117 (6725 104 St NW), Amrize Labourer (4425 92 Ave NW), Fountain Tire Service Advisor Leduc — see `APPLICATIONS_LOCAL.md` (#EK–#EN).

Skipped this run (fit/location/pay): White Cap Warehouse Associate (21359 115 Ave NW); Wolseley Waterworks Warehouse (116 Ave / 152 St NW); UniFirst Warehouse Worker re-post 4454348557 (already #Y); Rexel/Westburne Warehouse Clerk twin Edmonton South (already #DT); Stream-Flo Shipper-Receiver ALIS twin (already #CP); Uline Nights (St Albert 25 Richardson; prior Uline drafts); Kristian Electric Shipper (14236 121A Ave NW); EPCOR Labourer Aurum (NE); Blacksmith Technical SEO / Paid Search Manager (senior oversee specialists ~50); Snore MD Referral Marketing (BD ~42); Groupe Dynamite Paid Media (Montreal); EIZIE SEO spam locations; Smart Savvy Senior Marketing Manager (senior industrial stretch); Flexmatrix/Cloudcure SEO PT $25–30/hr pay floor; RONA Cashier Leduc (deferred vs warehouse/BOH); AMD/Markham and Toronto-only marketing roles.
...
| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C65 | Level Agency | Paid Media Manager | High (~74) | **PORTAL / LinkedIn** https://ca.linkedin.com/jobs/view/4429116239 | `cv/main_level_agency.pdf` | `cover_letters/cover_level_agency_paid_media_manager.pdf` | Remote US & Canada; CAD $80–115k posted; Google Ads + Meta match; LinkedIn/TikTok/DV360 + multi-million media books still growing vs 2 SMB accounts |
| C66 | Jobgether (partner) | Paid Media Specialist (Meta) | Good (~70) | **PORTAL / LinkedIn** https://ca.linkedin.com/jobs/view/4454757637 | `cv/main_jobgether_meta_paid.pdf` | `cover_letters/cover_jobgether_meta_paid_media_specialist.pdf` | Remote Canada; Meta Ads + creative tests match; Blueprint cert + large lookalike books still growing; confirm base ≥ CAD $60k |

**Mailto (Resend unset this run):** none verified public apply email for Level Agency or Jobgether Meta — use LinkedIn / careers portals. Local: Capital Chrysler AutoCanada careers; Sureway LinkedIn/careers; FedEx careers portal.

**Local drafts this run:** Capital Chrysler Wholesale Parts Advisor (1311 101 St SW), Sureway Shop Labourer (9175 14 St NW), FedEx Package Handler PT (6364 50 St NW) — see `APPLICATIONS_LOCAL.md` (#EC–#EE).

Skipped this run (fit/location/pay): Richards Packaging Shipper/Receiver (11420 163 St NW); Grainger Warehouse Associate (DC / 167 St NW pattern); Manulift Parts Specialist (15730 118 Ave NW); Finning Warehouse 7x7 (West Edmonton 170 St); St. Albert Honda Shipper/Receiver; Arrow General Labourer (Sherwood Park reload stretch vs closer SE picks); Alsco Mat Roller (123 Ave NW); HD Lot Windermere (public lot / PT); Walmart Stockperson Capilano 98 Ave; Walmart OMNI Kingsway Mall; LawDepot AI & Analytics Specialist LinkedIn re-post 4454677331 (prior skip ~55 scripting/degree); LawDepot Data Analyst re-post (already drafted C21); SimplyPHP Growth Marketing Lead (6+ yrs ~50); EverPro/Joist Growth Marketing Manager (strategic multi-million oversight ~52); Crimson Marketing Coordinator (coord stretch / pay unclear); BSI Marketing Coordinator (bilingual FR required); Saatchi SEO Manager Toronto; Klick SEM Manager Toronto; POD Senior Marketing Automation Calgary; Talentpulse aggregator posts (employer/pay/Canada unclear).

## NEW drafts this run (2026-08-21 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C63 | BlueTuskr | Search Advertising Specialist (E-Commerce) | Good (~72) | **PORTAL / LinkedIn** https://ca.linkedin.com/jobs/view/4455285321 | `cv/main_bluetuskr.pdf` | `cover_letters/cover_bluetuskr_search_advertising_specialist.pdf` | Remote; Google Ads Certified + 1–3 yrs SEM match; Shopping/PMax + pure ecom/D2C agency book still growing vs 2 SMB accounts; confirm base ≥ CAD $60k |
| C64 | ZayZoon | GTM Automation Specialist I | Good (~64) | **PORTAL / LinkedIn** https://ca.linkedin.com/jobs/view/4456758465 · https://jobs.ashbyhq.com/zayzoon | `cv/main_zayzoon.pdf` | `cover_letters/cover_zayzoon_gtm_automation_specialist.pdf` | Remote Canada/US; posted CA$94–135k; GHL + Claude automation match; HubSpot/Clay/Apollo RevOps depth still growing |

**Mailto (Resend unset this run):** Go Kia South Parts Advisor → `mailto:careers@goauto.ca?subject=Parts%20Advisor%20Go%20Kia%20South%20-%20Dylan%20Michael&body=Hi%2C%0A%0APlease%20find%20attached%20my%20resume%20for%20the%20Parts%20Advisor%20role%20at%20Go%20Kia%20South%20(3030%20Gateway%20Blvd%20NW).%0A%0AThanks%2C%0ADylan%20Michael%0A825-967-9337%0Adylanschule%40live.ca` · attach `cv/main_local_edmonton.pdf`. No verified public apply email for BlueTuskr or ZayZoon — use LinkedIn / Ashby. Local Allredi LinkedIn; Traction LinkedIn + 780-465-8010.

**Local drafts this run:** Allredi General Laborer (Leduc), Go Kia South Parts Advisor (Gateway Blvd), Traction/UAP Heavy Vehicle Parts Specialist (3404 78 Ave) — see `APPLICATIONS_LOCAL.md` (#DZ–#EB).

Skipped this run (fit/location/pay): Thorpe Warehouse Associate (16010 118 Ave NW); Perma Corp Labourer (14646 112 Ave NW); TK Elevator Warehouse Rep/Driver (10230 176 St NW); Powell Material Handler Acheson; Ryder Material Handler Sherwood Park (FIFO Fort Hills); McKesson warehouse (164 St NW pattern); BIS Website Performance Manager (5+ yrs web ownership + team lead ~55; Web Optimization Lead already drafted); Saatchi SEO Specialist ($50k pay floor); Blacksmith SEO Strategist (senior oversee specialists); KOHO / Hiive / Valnet / Blazesoft performance senior or location; Publicis Senior SEO/GEO; Directive Future Opening twin; Influence Agency / TopHat / Scale My Meal Prep GTA hybrid; Glowtify bilingual Montreal hybrid 5+ yrs; Stack Influence Digital Marketing Manager (Breezy closed); Hamak Stratège SEO (Montreal FR); Omnicom SEO Analyst Toronto; Sporting Life Organic Woodbridge; White Bay Vancouver hybrid; Google AE roles Toronto; Absorb/Intact/Artefact director-level.

## NEW drafts this run (2026-08-20 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C62 | Jobgether (partner) | Google Ads Manager | High (~74) | **PORTAL / LinkedIn** https://ca.linkedin.com/jobs/view/4454245279 · Jobgether apply flow | `cv/main_jobgether_google_ads.pdf` | `cover_letters/cover_jobgether_google_ads_manager.pdf` | Remote Canada; EST Mon–Fri; Google Ads Certified required (match); Search/SEM/PPC + agency match; Display/YouTube + large multi-client SEM book still growing vs 2 SMB accounts; confirm base ≥ CAD $60k |

**Mailto (Resend unset this run):** none verified public apply email for Jobgether Google Ads Manager — use LinkedIn / Jobgether. Local optional: Echelon `mailto:edmontonsales@echelonsupply.com` (confirm HR inbox); Surepoint portal/phone 780-955-3939; Allegion LinkedIn/careers.

**Local drafts this run:** Echelon Warehouse Associate (8440 Roper Rd), Surepoint Shipper/Receiver (Nisku), Allegion Warehouse Worker (5136 75 St) — see `APPLICATIONS_LOCAL.md` (#DW–#DY).

Skipped this run (fit/location/pay): E.B. Horsman Material Handler (11767 186 St NW); Fastener Group Edmonton West; Wolseley / Guillevin NW branches; 7-Eleven Parts Warehouse (14434 157 Ave NW); Walmart Stock Unloader Tamarack / Sherwood Park Wye Rd; Walmart Leduc Unloader twin of #DP; Cummins Warehouse Operator (address unverified / stretch); Trouw Nutrition Sherwood Park (Liberty Rd; deferred vs closer Roper/Nisku picks); Thermo King Materials Handler (T5V NW); Resolver Senior Performance Marketing (Toronto hybrid $85–105k); Executrade Marketing Generalist (~58; Adobe Commerce/Klaviyo lead stretch); Robert Half Senior Digital Marketing Strategist (~50); SimplyAsk.ai Brand & Demand (~58; HubSpot/Figma hard); Safe Software B2B Social (~52); Jobgether Senior SEO Lead / UA Manager Meta 3+ yrs; Atomic Creative Strategist US DTC; Aylo Growth (adult vertical prior); Directive Future Opening; Kanopi Senior Content contract; Corus Sales Promotion Coordinator.
...
|---|---------|------|-------|-------|
| E11 | Webhorse Technologies | SEO & Online Marketing Specialist | contact@webhorse.ca | Remote/Inuvik listing |
| E12 | The Headhunters client | Marketing Manager | info@theheadhunters.ca | $80–95k; 6–10 yrs leadership gap noted |
| E13 | Recruitment Partners | Digital Marketing Manager 13-mo | careers@rpinc.ca (Bobi-Jo) | Separate from prior RP Marketing Manager email |
| E14 | ATRIUM Digital | Advertising Specialist | contact@atriumdigital.com | Edmonton in-office; $55–75k |
| E15 | MG Precast | Material Handler | mgprecaststeps@gmail.com | Local survival; $23/hr |
| E16 | Search Engine People | Sr SEO Strategist | HR@sep.ca / HR@searchenginepeople.com | Evergreen pipeline |
| E17 | Goose Digital | Account Lead, Digital Solutions | renata@goosedigital.com | Edmonton hybrid; email submitted this run |
| E18 | Goose Digital | Demand Generation Specialist | renata@goosedigital.com | Edmonton hybrid; email submitted this run |

## NEW drafts this run (2026-07-22 daily scrape)

| # | Company | Role | Fit | Apply | CV | Cover | Honesty notes |
|---|---------|------|-----|-------|----|-------|---------------|
| C15 | Goose Digital | Account Lead, Digital Solutions | High (~78) | **EMAIL SUBMITTED** renata@goosedigital.com · https://goosedigital.com/job/account-lead-digital-solutions/ | `cv/main_goose_digital.pdf` | `cover_letters/cover_goose_digital_account_lead.pdf` | Edmonton hybrid 4–5 days on-site; degree listed as benefit not hard req |
| C16 | Goose Digital | Demand Generation Specialist | High (~80) | **EMAIL SUBMITTED** renata@goosedigital.com · https://goosedigital.com/job/demand-generation-specialist/ | `cv/main_goose_digital.pdf` | `cover_letters/cover_goose_digital_demand_generation.pdf` | Same Edmonton hybrid; Google/Meta paid focus |
...
| 9 | LAG Auto | Marketing Manager | **Email:** hiring@lagauto.ca | `cv/main_lag_auto.pdf` | `cover_letters/cover_lag_auto_marketing_manager.pdf` | **SUBMITTED 2026-07-22** via Resend (`14e431e7…`). $80k+. |
...
| 3 | LawDepot | Digital Marketing Automation Specialist | **Email submitted** career@lawdepot.ca | `cv/main_lawdepot.pdf` | `cover_letters/cover_lawdepot_digital_marketing_automation_specialist.pdf` | **SUBMITTED 2026-07-22** (`28c53902…`). Degree gap noted in letter. |
| 4 | CREATIVE Agency | SEO Specialist | **Email submitted** hello@acreativeagency.ca | `cv/main_creative.pdf` | `cover_letters/cover_creative_seo_specialist.pdf` | **SUBMITTED 2026-07-22** (`5b2c5cdd…`). Optional web form follow-up. |
| 5 | Randstad client | Digital Marketing Manager (13-mo) | **Email submitted** chloe.naccache@randstad.ca | `cv/main_randstad.pdf` | `cover_letters/cover_randstad_digital_marketing_manager.pdf` | **SUBMITTED 2026-07-22** (`e3f026a5…`). $75–90k remote. |
| 6 | Durabuilt Windows & Doors | Digital Marketing Manager | **Email submitted** hr@durabuiltwindows.com | `cv/main_durabuilt.pdf` | `cover_letters/cover_durabuilt_digital_marketing_manager.pdf` | **SUBMITTED 2026-07-22** (`a7c31d3a…`). Experience gap noted in letter. |
